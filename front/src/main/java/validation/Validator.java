...
public class Validator {
    ...
    public static String getCurrentTable(String currentClass){
        switch (currentClass) {
            default:
            case "model.TesttypeModel":     return "testtypes";
            case "model.TestcaseModel":      return "testcases";
            case "model.RequestModel":     return "requests";
            case "model.TesterModel":     return "testers";
            case "model.UserModel":         return "users";
            case "model.TestmachineModel":    return "testmachines";
            case "model.TesterTestcaseModel":  return "tester_testcases";
            case "model.UserTesttypeModel":     return "user_testtypes";
        }
    }

    public static void setSize(CDialog dialog, int y){
        Point point = dialog.getLocation();
        dialog.setLocation(point.x,y);
    }

    public static void setSize(CDialogNotFrame dialog, int y){
        Point point = dialog.getLocation();
        dialog.setLocation(point.x,y);
    }
}
